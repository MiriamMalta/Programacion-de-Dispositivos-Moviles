...
import 'package:music_app/music/bloc/favorites_bloc.dart';

import 'Xitem_song.dart';
...
class _FavoritesState extends State<FavoritesS> {
  final List<dynamic> _listElements = [
    {
      "title": "Warriors",
      "artist": "Imagine Dragons",
      "image": "https://i.scdn.co/image/d3acaeb069f37d8e257221f7224c813c5fa6024e"
    },
  ];
    ...
    return BlocConsumer<FavoritesBloc, FavoritesState>(
      ...
      builder: (context, state) {
        ...
        if (state is FavoritesPutState) {
          ...
          if (_listSongs == []) return _empty(context);
